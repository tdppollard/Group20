...
data %>%
  ...
  geom_boxplot(fill = c(rep("orange",6),rep("limegreen",6),rep("orange",6),rep("limegreen",6))) +
  theme(axis.text.x = element_text(angle = -45)) +
  facet_wrap(~year) +
  labs(x = "Group", y = "Years in school")
...
conclusion about questions of interest
...
For the first question, according to the regression results, time children spend in school has a significant effect on the wealth of the country. Other things being equal, each one-year increase in time children spend in school increases logGDP by 0.88259.And for every 1 reduction in child mortality increases logGDP by 0.01878

For the second question,Child mortality, school years and female participation in the workforce were most significantly related to national wealth in 1990.But in 2015 only Child mortality had a significant relationship with national wealth.Female participation is no longer significant or even negatively correlated with national wealth in 2015, while fertility is significantly correlated with national wealth, perhaps indicating a gradual deterioration in women's participation in the workforce and the need for greater protection of women's work right.
