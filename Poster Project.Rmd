...
school2015 %>%
  na.omit() %>%
  ggplot(aes(women25_34, logGDP)) + geom_point() + geom_smooth(method = "lm", se = FALSE, colour = "limegreen") +
  labs(x = "Years in school - women aged 25-34", title = "Data from 2015",y="log GDP")
...
p1<-school1990 %>%
  na.omit() %>% # Remove missing values
  ggplot(aes(women25_34, logGDP)) + geom_point() + geom_smooth(method = "lm", se = FALSE, colour = "limegreen") + labs(x = "Years in school - women aged 25-34", title = "Data from 1990",y="log GDP")

p2<-school1990 %>%
  na.omit() %>% # Remove missing values
  ggplot(aes(men25_34, logGDP)) + geom_point() + geom_smooth(method = "lm", se = FALSE, colour = "limegreen") +
  labs(x = "Years in school - men aged 25-34", title = "Data from 1990",y="log GDP")
...
p4<-school2015 %>%
  na.omit() %>%
  ggplot(aes(men25_34, logGDP)) + geom_point() + geom_smooth(method = "lm", se = FALSE, colour = "limegreen") +
  labs(x = "Years in school - men aged 25-34", title = "Data from 2015",y="log GDP")
